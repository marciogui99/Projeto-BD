...
INSERT INTO partido VALUES ('PSOL', 'Partido da liberdade');
INSERT INTO partido VALUES ('PSC', 'Partido Cristao');
INSERT INTO partido VALUES ('PSDB', 'Tucanos');
INSERT INTO partido VALUES ('PSL', 'Tradicao e aventura');  -- Pode string vazia
INSERT INTO partido VALUES ('PSM', 'O maior dos maiores');
SELECT * FROM partido;

INSERT INTO cargo(nome,cidade,uf,federacao,qtd_eleitos) VALUES ('Prefeito', 'Belo Horizonte', 'MG', 'BR', 1);
INSERT INTO cargo(nome,cidade,uf,federacao,qtd_eleitos) VALUES ('Deputado', 'Belo Horizonte', 'MG', 'BR', 15);
INSERT INTO cargo(nome,qtd_eleitos) VALUES ('Senador', 3);
INSERT INTO cargo(nome,qtd_eleitos) VALUES ('Presidente', 1);
INSERT INTO cargo(nome,cidade,uf,federacao,qtd_eleitos) VALUES ('Vereador', 'Belo Horizonte', 'MG', 'BR', 9);
...
INSERT INTO cargo(nome,uf,qtd_eleitos) VALUES ('Governador','SP', 1);
INSERT INTO cargo(nome,uf,qtd_eleitos) VALUES ('Deputado Estadual','SP', 5);
INSERT INTO cargo(nome,uf,qtd_eleitos) VALUES ('Deputado Estadual','BA', 5);
INSERT INTO cargo(nome,cidade,uf,qtd_eleitos) VALUES ('Vereador','Feira de Santana','BA', 10);
SELECT * FROM cargo;

INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('9', '2020', 2, 'PSOL', 200) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('12', '2018', 5, 'PSC', 120) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('2', '2020', 2, 'PSOL', 270) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('2', '2014', 2, 'PSOL', 270) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('3', '2016', 15, 'PSDB', 120) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('11', '2020', 5, 'PSL', 24) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('10', '2020', 13, 'PSL', 1200);
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('104', '2022', 14, 'PSDB', 1000) RETURNING *;
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('4', '2022', 13, 'PSL', 1200);
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('1', '2020', 3, 'PSOL', 1200);
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('104', '2020', 4, 'PSOL', 1100);
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('145', '2020', 3, 'PSOL', 12120);
INSERT INTO candidatura(doc_candidato, ano_eleicao, cod_cargo, partido, pleito) VALUES ('4', '2020', 4, 'PSL', 1120);
